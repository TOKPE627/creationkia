...
@RestController
@RequestMapping("/uploadGroupSale")
public class RestUploadGroupSaleGaleryController {
    ...
    private void saveUploadedFiles(List<MultipartFile> files,Long idGalery) throws IOException {
        ...
        for (MultipartFile file : files) {
            ...
            storageService.uploadRestFileInAws(AppConstants.bucket_groupsale, idGalery,file);
        }
