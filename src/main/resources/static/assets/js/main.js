...
$('[data-countdown]').each(function() {
	...
	$this.html(event.strftime('<span class="cdown days"><span class="time-count">%-D</span><p>Js</p></span> <span class="cdown hour"><span class="time-count">%-H</span> <p>H</p></span> <span class="cdown minutes"><span class="time-count">%M</span> <p>M</p></span> <span class="cdown second"> <span><span class="time-count">%S</span> <p>S</p></span>'));
	});
